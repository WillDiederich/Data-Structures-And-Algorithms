...
public class FindStronglyConnectedComponents_Tarjan {
    ...
    public static void dfs(List<List<Integer>> adjacencyList, List<List<Integer>> components, Stack<Integer> stack, boolean[] onStack, int[] indices, int[] low, int currentVertex, int index){
